...
{% include gallery-figure.html img="practice_13.png" alt="A collage of four black-and-white photographs titled The Purpose of a Code of Ethics with a subtitle Interior shots of the Bibliothèque Nationale from Alain Resnais Tout la Mémorie du Monde, 1956. The top left photo shows the ceiling of a grand library with circular windows." %}
...
{% include gallery-figure.html img="practice_14.png" alt="Society of American Archivists Code of Ethics, authenticity and integrity, featuring a left bookplate of Jan Six (1874-1936) and a right emblem with an eagle." %}
...
{% include gallery-figure.html img="practice_15.png" alt="Society of American Archivists Code of Ethics, focusing on the Transparency and Accountability section. On the left, there is a document titled Left Special Collections Finding Aid for the President's Office (Hartung) records, 1972-1977. On the right, a screenshot of metadata featuring transcriber information." %}
...
{% include gallery-figure.html img="practice_16.png" alt="A hand is holding an open book with braille, placed on a surface next to a circular inset showing a book scanner in use. The image features the title SOCIETY OF AMERICAN ARCHIVISTS CODE OF ETHICS, Access and Equity." %}
...
{% include gallery-figure.html img="practice_17.png" alt="Lenexa National Archives Federal Records Center, featuring a photograph of a large storage area with wooden shelves labeled with numbers. To the right, there is a diagram titled Digital Archiving Workflow with steps including pre-retrieval appraisals, acquisition, and accessioning, with various decision points and processes outlined in blue and yellow boxes." %}
...
{% include gallery-figure.html img="practice_18.png" alt="A Recent History of Proprietary 'Rug Pulls' in four news articles." %}
